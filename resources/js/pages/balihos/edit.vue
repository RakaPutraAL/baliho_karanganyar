        ...
        <div class="p-4">
            <form @submit.prevent="handleSubmit" class="w-8/12 space-y-4">
                ...
                <div class="space-y-2">
                    ...
                    <select v-model="form.opd_id" class="w-full rounded-xl border border-gray-600 bg-gray-900 p-3 text-gray-100 shadow-sm">
                ...
                <div class="space-y-2">
                    ...
                    <select v-model="form.kode" class="w-full rounded-xl border border-gray-600 bg-gray-900 p-3 text-gray-100 shadow-sm">
                ...
                <div class="space-y-2">
                    ...
                    <img
                        v-if="props.baliho.foto"
                        :src="`${props.baseUrl}/uploads/${props.baliho.foto}`"
                        alt="Gambar Baliho"
                        class="mt-2 h-auto w-40 rounded shadow"
                    />
                </div>
